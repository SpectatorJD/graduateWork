...
public class Ads {
    ...
    public CreateOrUpdateAd createAd( @RequestBody CreateOrUpdateAd createUpdate, @RequestParam MultipartFile ad) {
...
//Добавление комментария к объявлению
            ...
            public CreateOrUpdateComment createComment(@PathVariable Long id,@RequestBody CreateOrUpdateComment createComment) {
...
//Обновление комментария
            ...
            public ResponseEntity<CreateOrUpdateComment> UpdateComment(@PathVariable Long id,@RequestBody CreateOrUpdateComment UpdateComment) {
